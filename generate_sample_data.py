...
def generate_part_data(part_sn):
    types = ['PC3', 'PC3L', 'PC4', 'HD 2.5', 'HD 3.5', 'SSD', 'm.2', 'NVMe', 'mSATA', 'Apple']
    capacities = {
        'PC3': ['2GB', '4GB', '8GB'],
        'PC3L': ['2GB', '4GB', '8GB'],
        'PC4': ['2GB', '4GB', '8GB', '16GB', '32GB', '64GB', '128GB'],
        'HD 2.5': ['300GB', '500GB', '600GB', '750GB', '1TB', '1.5TB', '2TB', '3TB', '4TB', '5TB'],
        'HD 3.5': ['300GB', '500GB', '600GB', '750GB', '1TB', '1.5TB', '2TB', '3TB', '4TB', '5TB'],
...
def generate_log_entry(part_sn):
    ...
    tid = f'TI{random.randint(100000, 999999)}-{random.randint(100000, 999999)}'
    unit_sn = ''.join(random.choices(string.ascii_uppercase + string.digits, k=8))
